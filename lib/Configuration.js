...
/**
 * SDK configuration for MonCash API credentials and environment.
 */
class Configuration {
    /**
     * @param {string|object} clientId - API client ID or options object
     * @param {string|object} [clientSecret] - API client secret or options object
    ...
    _defaultOptions = {
        v1:{
            live:{
                ...
                customer_status_uri:    "/v1/CustomerStatus",
                prefunded_status_uri:   "/v1/PrefundedTransactionStatus",
                prefunded_balance_uri:  "/v1/PrefundedBalance",
            },
            sandbox:{
    ...
    /**
     * Merge and apply configuration options.
     ...
     * @param {object} [options] - Options to validate instead of instance options
     * @returns {boolean} True when validation passes
     * @throws {MoncashError} When configuration is invalid
     */
    validate(options){
